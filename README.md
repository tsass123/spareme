...
<img src="Logo.png" alt="Spare Me" width="100" height="100" style="opacity:0.4;filter:alpha(opacity=40);"><h1 style="text-align:center;">Spare Me</h1>
  <h2 style="text-align:center;">Elevate Game with Analytics</h2>
